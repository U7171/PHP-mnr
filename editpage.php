        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <form action="updpage.php" enctype = "multipart/form-data" method = "POST">
                        <input type="hidden" name="id" value="<?php echo $data['pid'];?>" />
                        <p>Page Title</p>
                        <p><input value="<?php echo $data['pname']; ?>" type="text" name="ptitle" id="ptitile" class="form-control"></p>

                        <p>Image</p>
                        <p><input type="file" name="pimg" id="pimg"></p>
                        <p><img  style="width:100px;" src="images/<?php echo $data['image']?>"/></p>

                        <p>Description</p>
                        <p><textarea class="form-control" id="editor" rows="3" name = "editor"><?php echo $data['details']; ?></textarea></p>
                        <script>
                        ClassicEditor
